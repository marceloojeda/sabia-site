...
# Dump da base
mysqldump -u root -p udv_sabia > /var/www/data/09-abr.sql

# Copia do servidor
sudo scp -i ojeda_ec2-sabia.pem ubuntu@52.91.174.190:/home/ubuntu/09-abr.sql /home/marcelo/Documentos/Ojeda
